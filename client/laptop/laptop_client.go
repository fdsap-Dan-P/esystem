...
func (laptopClient *LaptopClient) UploadImage(laptopID int64, imagePath string) {
...
func (laptopClient *LaptopClient) RateLaptop(laptopIDs []int64, scores []float64) error {
	ctx, cancel := context.WithTimeout(context.Background(), 5*time.Second)
	defer cancel()
