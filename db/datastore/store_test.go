...
func TestTransferTx(t *testing.T) {
	...
	account1, _ := store.GetAccountbyAltAcc(context.Background(), "1001-0001-0000001")
	account2, _ := store.GetAccountbyAltAcc(context.Background(), "1001-0001-0000002")
	...
	fmt.Println(">> before2:", account1.Balance, account2.Balance)

	errs := make(chan error)
	results := make(chan TransferTxResult)

	fmt.Println(">> before3:", account1.Balance, account2.Balance)

	// run n concurrent transfer transaction
	for i := 0; i < n; i++ {
		go func() {
			fmt.Println(">> beforei:", account1.Balance, account2.Balance)
	...
	for i := 0; i < n; i++ {
		...
		log.Println("transfer.Id", transfer.Id)
