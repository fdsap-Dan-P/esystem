...
func TestCustomer(t *testing.T) {
	...
	// Get Data
	getData1, err1 := testQueriesLocal.GetCustomer(context.Background(), d1.CID)
	...
	getData2, err2 := testQueriesLocal.GetCustomer(context.Background(), d2.CID)
	...
	getData1, err1 = testQueriesLocal.GetCustomer(context.Background(), updateD2.CID)
	require.NoError(t, err1)
	...
	// Delete Data
	testDeleteCustomer(t, d1.CID)
	testDeleteCustomer(t, d2.CID)
}

func testListCustomer(t *testing.T, arg ListCustomerParams) {

	Customer, err := testQueriesLocal.ListCustomer(context.Background())
	require.NoError(t, err)
	// fmt.Printf("%+v\n", Customer)
...
func createTestCustomer(
	t *testing.T,
	req CustomerRequest) error {

	err1 := testQueriesLocal.CreateCustomer(context.Background(), req)
	...
	getData, err2 := testQueriesLocal.GetCustomer(context.Background(), req.CID)
	require.NoError(t, err2)
...
func updateTestCustomer(
	t *testing.T,
	d1 CustomerRequest) error {

	err := testQueriesLocal.UpdateCustomer(context.Background(), d1)
	require.NoError(t, err)

	return err
}

func testDeleteCustomer(t *testing.T, CID int64) {
	err := testQueriesLocal.DeleteCustomer(context.Background(), CID)
	require.NoError(t, err)

	ref1, err := testQueriesLocal.GetCustomer(context.Background(), CID)
	require.Error(t, err)
