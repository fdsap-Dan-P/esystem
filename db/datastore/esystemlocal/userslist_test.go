...
func TestUsersList(t *testing.T) {
	...
	// Get Data
	getData1, err1 := testQueriesLocal.GetUsersList(context.Background(), d1.UserId)
	...
	require.Equal(t, d1.DateHired, getData1.DateHired)
	require.Equal(t, d1.BirthDay, getData1.BirthDay)
	require.Equal(t, d1.DateGiven, getData1.DateGiven)
	require.Equal(t, d1.DateExpired, getData1.DateExpired)
	...
	require.Equal(t, d1.DateLocked, getData1.DateLocked)
	...
	require.Equal(t, d1.AccountExpirationDt, getData1.AccountExpirationDt)

	getData2, err2 := testQueriesLocal.GetUsersList(context.Background(), d2.UserId)
	...
	require.Equal(t, d2.DateHired, getData2.DateHired)
	require.Equal(t, d2.BirthDay, getData2.BirthDay)
	require.Equal(t, d2.DateGiven, getData2.DateGiven)
	require.Equal(t, d2.DateExpired, getData2.DateExpired)
	...
	require.Equal(t, d2.DateLocked, getData2.DateLocked)
	...
	require.Equal(t, d2.AccountExpirationDt, getData2.AccountExpirationDt)
	...
	getData1, err1 = testQueriesLocal.GetUsersList(context.Background(), updateD2.UserId)
	require.NoError(t, err1)
	...
	require.Equal(t, updateD2.DateHired, getData1.DateHired)
	require.Equal(t, updateD2.BirthDay, getData1.BirthDay)
	require.Equal(t, updateD2.DateGiven, getData1.DateGiven)
	require.Equal(t, updateD2.DateExpired, getData1.DateExpired)
	...
	require.Equal(t, updateD2.DateLocked, getData1.DateLocked)
	...
	require.Equal(t, updateD2.AccountExpirationDt, getData1.AccountExpirationDt)
	...
	// Delete Data
	testDeleteUsersList(t, d1.UserId)
	testDeleteUsersList(t, d2.UserId)
}

func testListUsersList(t *testing.T, arg ListUsersListParams) {

	UsersList, err := testQueriesLocal.ListUsersList(context.Background())
	require.NoError(t, err)
	// fmt.Printf("%+v\n", UsersList)
...
func randomUsersList() UsersListRequest {

	arg := UsersListRequest{
		UserId:              "User",
...
func createTestUsersList(
	t *testing.T,
	req UsersListRequest) error {

	err1 := testQueriesLocal.CreateUsersList(context.Background(), req)
	...
	getData, err2 := testQueriesLocal.GetUsersList(context.Background(), req.UserId)
	require.NoError(t, err2)
	...
	require.Equal(t, req.DateHired, getData.DateHired)
	require.Equal(t, req.BirthDay, getData.BirthDay)
	require.Equal(t, req.DateGiven, getData.DateGiven)
	require.Equal(t, req.DateExpired, getData.DateExpired)
	...
	require.Equal(t, req.DateLocked, getData.DateLocked)
	...
	require.Equal(t, req.AccountExpirationDt, getData.AccountExpirationDt)
...
func updateTestUsersList(
	t *testing.T,
	d1 UsersListRequest) error {

	err := testQueriesLocal.UpdateUsersList(context.Background(), d1)
	require.NoError(t, err)

	return err
}

func testDeleteUsersList(t *testing.T, userId string) {
	err := testQueriesLocal.DeleteUsersList(context.Background(), userId)
	require.NoError(t, err)

	ref1, err := testQueriesLocal.GetUsersList(context.Background(), userId)
	require.Error(t, err)
